            ...
            >
              ...
              <iframe
                src={`https://view.officeapps.live.com/op/embed.aspx?src=${encodeURIComponent(
                  window.location.origin + "/resume.docx"
                )}`}
                width="100%"
                height="500px"
                frameBorder="0"
          ...
          >
            ...
            >
              ...
              <p className="text-gray-300 text-center">
                Interested in working together? Contact me via the Contact section or email <span className="text-[#38bdf8]">em.usama@gmail.com</span>.
              </p>
              <a
                href="#Contact"
